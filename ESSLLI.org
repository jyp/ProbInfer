...
*** Bare plurals, Generics, and Indefinite Noun phrases
    ...
    They serve as generalized quantifiers (like most) and they also may carry generic meaning, as it is in 
    the following exammples:
    ...
    they also show some traits of generic readings:
...
*** Adverbs of frequency
    ...
    Adverbs of frequency interact with quantifiers. It's important to ensure their swift interaction 
    in order to make a meaningful test suite example.
